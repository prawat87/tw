...
unset($__errorArgs, $__bag); ?>" name="email" value="" placeholder="<?php echo e(__('Email')); ?>" required autofocus>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input id="password" type="password" value="" class="form-control  <?php $__errorArgs = ['password'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="col-xl-6 img-card-side">
            <div class="auth-img-content">
                ...
                <p class="text-white"> <?php echo e(__('The more effortless the writing looks, the more effort the writer actually put into the process.')); ?></p>
            </div>
        </div>
    </div>
</div>
...
<?php echo $__env->make('layouts.auth', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\wamp64\www\switches\resources\views/auth/login.blade.php ENDPATH**/ ?>