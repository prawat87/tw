    ...
    <?php $__currentLoopData = $timeSheets; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $date => $logs): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        ...
        <tr>
            ...
            <td>
              ...
              <img src='<?php echo e(asset("storage/productimages/$user_avtar")); ?>' alt="" style="width: 45px; height: 45px" class="rounded-circle" />
              </div>
              <div>
...
<?php /**PATH D:\wamp64\www\teamwork\resources\views/projects/teamTimeSheetShowMore.blade.php ENDPATH**/ ?>