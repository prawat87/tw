...
<?php $__env->startSection('action-button'); ?>
    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('manage timesheet')): ?>
        <a href="#!" data-bs-toggle="tooltip" data-bs-placement="top" class="filter-records btn btn-sm btn-primary btn-icon"
            title="<?php echo e(__('Filter')); ?>"><i class="ti ti-filter"></i></a>
...
<button type="button" class="btn btn-primary my-2" data-endDate="" data-lastDate="<?php echo e($lastDate); ?>" id="showMore">Show More</button>
<?php endif; ?>
    <!-- Sidebar -->
...
<script>
    ...
    var config = {
        routes: {
            filter: "<?php echo e(route('timesheet.entries.filter')); ?>"
        }
    };
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\wamp64\www\teamwork\resources\views/projects/timeSheet.blade.php ENDPATH**/ ?>