            ...
            if($invoice && $request->has('status'))
            {
                try
                {
                    ...
                    {  
                        ...
                        $new->transaction_id = app('App\Http\Controllers\InvoiceController')->transactionNumber($users);
                        ...
                        if(\Auth::check())
                           ...
                           if(\Auth::check())
                                ...
                                {
                                    return redirect()->route('pay.invoice',\Illuminate\Support\Facades\Crypt::encrypt($invoice->id))->with('error', __('Transaction fail'));
                                }
                    ...
                    if(\Auth::check())
                               {
                                 ...
                                 {
                                     return redirect()->route('pay.invoice',\Illuminate\Support\Facades\Crypt::encrypt($invoice->id))->with('error', __('Plan not found!'));
                              }
