...
class ContractTypeController extends Controller
{
    ...
    public function index()
    {
        ...
        // {
            $contractTypes = ContractsType::where('created_by', '=', \Auth::user()->creatorId())->get();
    ...
    public function store(Request $request)
    {
        ...
        // {
            ...
            $contractType                 = new ContractsType();
     ...
     * @return \Illuminate\Http\Response
     */
    public function show(ContractsType $contractType)
    {
     ...
     * @return \Illuminate\Http\Response
     */
    public function edit(ContractsType $contractType)
    {
     ...
     * @return \Illuminate\Http\Response
     */
    public function update(Request $request, ContractsType $contractType)
    {
        // if(\Auth::user()->can('Edit Contract Type'))
        // {
            if($contractType->created_by == \Auth::user()->creatorId())
     ...
     * @return \Illuminate\Http\Response
     */
    public function destroy(ContractsType $contractType)
    {
