...
<body class="{{ !empty($color) ? $color : 'theme-3' }}">
    ...
    <nav class="navbar navbar-expand-md navbar-dark default">
        <div class="container">
            <a class="navbar-brand bg-transparent" href="#">
                ...
                <img alt="logo" src="{{ $logo . 'logo-light.png' }}" class="navbar-brand-img auth-navbar-brand">
            </a>
            ...
            <div class="row align-items-center justify-content-between">
                <div class="col-sm-5">
                    ...
                    <h2 class="text-white mb-sm-4 wow animate__fadeInLeft" data-wow-delay="0.4s">
                        Lead and Project Management Tool<br />
                    </h2>
                    ...
                    <div class="my-4 wow animate__fadeInLeft" data-wow-delay="0.8s">
                        <a href="{{ route('login') }}" class="btn btn-light me-2"><i class="far fa-eye me-2"></i>Live
                            Demo</a>
                        <a href="https://codecanyon.net/item/workgo-saas-lead-and-project-management-tool/25266631?s_rank=30"
    ...
    <section id="dashboard" class="theme-alt-bg dashboard-block">
        <div class="container">
            ...
            <div class="row align-items-center justify-content-center mobile-screen">
              ...
              /> --}}
                        <img src="{{ $logo . '/' . (isset($company_logo) && !empty($company_logo) ? $company_logo : 'logo-dark.png') }}"
                            alt="{{ config('app.name', 'Workgo SaaS') }}" class="logo logo-lg">
                    </div>
                </div>
                <div class="col-auto">
            ...
            <img src="{{ asset('custom/images/landing/Dashboard.png') }}" alt=""
                class="img-fluid img-dashboard wow animate__fadeInUp mt-5 rounded" data-wow-delay="0.2s" />
        </div>
    </section>
    <!-- [ client ] End -->
    <!-- [ dashboard ] start -->
            ...
            <div class="row align-items-center justify-content-end mb-5">
                <div class="col-sm-4">
                    ...
                    <h2 class="mb-sm-4 wow animate__fadeInLeft" data-wow-delay="0.4s">
                        Lead and Project Management Tool
                    </h2>
                    <p class="mb-sm-4 wow animate__fadeInLeft" data-wow-delay="0.6s">
                        Use these awesome forms to login or create new account in your
                        project for free.
                ...
                <div class="col-sm-6">
                    <img src="{{ asset('custom/images/landing/Dashboard.png') }}" alt="Datta Able Admin Template"
                        class="img-fluid header-img wow animate__fadeInRight rounded" data-wow-delay="0.2s" />
                </div>
            </div>
    ...
    <section id="feature" class="feature">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-xl-6 col-md-9 title">
                    <h2>
                        <span class="d-block mb-3">Features</span> Lead and Project Management Tool
                    </h2>
                    <p class="m-0">
                        Use these awesome forms to login or create new account in your
                        project for free.
    ...
    <section class="">
        <div class="container">
            <div class="row align-items-center justify-content-end mb-5">
                ...
                <div class="col-sm-6">
                    <img src="{{ asset('custom/images/landing/img-crm-dash-3.svg') }}"
                ...
                <div class="col-xl-9 col-lg-6 col-md-12 col-sm-12">
                    <div class="row feature-img-row m-auto">
                        <div class="col-lg-3 col-sm-6">
                            <img src="{{ asset('custom/images/landing/Dashboard.png') }}"
                                class="img-fluid header-img wow animate__fadeInRight rounded" data-wow-delay="0.2s"
                                alt="Admin" />
                        </div>
                        <div class="col-lg-3 col-sm-6 mt-2">
                            <img src="{{ asset('custom/images/landing/img-2.png') }}"
                                class="img-fluid header-img wow animate__fadeInRight rounded" data-wow-delay="0.4s"
                                alt="Admin" />
                        </div>
                        <div class="col-lg-3 col-sm-6 mt-2">
                            <img src="{{ asset('custom/images/landing/img-3.png') }}"
                                class="img-fluid header-img wow animate__fadeInRight rounded" data-wow-delay="0.6s"
                                alt="Admin" />
                        </div>
                        <div class="col-lg-3 col-sm-6 mt-2">
                            <img src="{{ asset('custom/images/landing/img-4.png') }}"
                                class="img-fluid header-img wow animate__fadeInRight rounded" data-wow-delay="0.8s"
                                alt="Admin" />
                        </div>
                        <div class="col-lg-3 col-sm-6 mt-2">
                            <img src="{{ asset('custom/images/landing/img-5.png') }}"
                                class="img-fluid header-img wow animate__fadeInRight rounded" data-wow-delay="0.3s"
                                alt="Admin" />
                        </div>
                        <div class="col-lg-3 col-sm-6 mt-2">
                            <img src="{{ asset('custom/images/landing/img-6.png') }}"
                                class="img-fluid header-img wow animate__fadeInRight rounded" data-wow-delay="0.5s"
                                alt="Admin" />
                        </div>
                        <div class="col-lg-3 col-sm-6 mt-2">
                            <img src="{{ asset('custom/images/landing/img-7.png') }}"
                                class="img-fluid header-img wow animate__fadeInRight rounded" data-wow-delay="0.7s"
                                alt="Admin" />
                        </div>
                        <div class="col-lg-3 col-sm-6 mt-2">
                            <img src="{{ asset('custom/images/landing/img-8.png') }}"
                                class="img-fluid header-img wow animate__fadeInRight rounded" data-wow-delay="0.9s"
                                alt="Admin" />
                        </div>
                    </div>
                </div>
