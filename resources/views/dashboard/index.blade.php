        ...
        var teamLoggedHoursChart = (function() {
            ...
            function initTeamLog($this) {
                var teamLoggedHoursChart = new Chart($this, {
                    ...
                    data: {
                        labels: {!! json_encode($teamLoggedData['label']) !!},
                        datasets: {!! json_encode($teamLoggedData['dataset']) !!}
                    },
                    options: {
                        title: {
                            display: true,
                            text: "Total Logged Hours: " + {!! $teamLoggedData['total_logged_hrs'] !!}
                        },
                        responsive: true,
                        tooltip: {
                            mode: 'index'
            ...
            function init($this) {
                var loggedHoursChart = new Chart($this, {
                    ...
                    options: {
                        title: {
                            display: true,
                            text: "Total Logged Hours: " + {!! $taskData['total_logged_hrs'] !!}
                        },
                        responsive: true,
                        tooltip: {
                            mode: 'index'
